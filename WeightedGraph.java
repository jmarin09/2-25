...
public class WeightedGraph<T> implements WeightedGraphInterface<T>
{
  ...
  {
    Queue<T> adjVertices = new ArrayDeque<>();
  ...
  {
	  marks = new boolean[DEFCAP];
	  //reinitialize marks array with new keyword  
  }
  ...
  // Marks vertex.
  {
	//get index of vertex
	 indexIs(vertex);
	//set marks at the index place to true
  }
  ...
  {
	  //search for an unmarked vertex and return it
	  return null;
  }
